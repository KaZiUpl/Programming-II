...
int main()
{
    ...
    {
        Rational fraction(first,second);
        cout<<"[";
        div = fraction.get_numerator()/fraction.get_denominator();
        cout<<div;
        fraction = fraction-div;
        if(fraction.get_denominator() >= fraction.get_numerator())
        {
            cout<<";";
            do
            {
                fraction.swap_num_denom();
                div = fraction.get_numerator()/fraction.get_denominator();
                fraction = fraction-div;
                cout<<div;
                if(fraction.get_denominator() >= fraction.get_numerator() && fraction.get_numerator() > 0)
                {
                    cout<<",";
                }
            }while(fraction.get_denominator() >= fraction.get_numerator() && fraction.get_numerator() > 0);
